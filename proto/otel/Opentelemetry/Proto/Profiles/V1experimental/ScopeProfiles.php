 ...
 *
 * Generated from protobuf message <code>opentelemetry.proto.profiles.v1experimental.ScopeProfiles</code>
 */
class ScopeProfiles extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.profiles.v1experimental.ProfileContainer profiles = 2;</code>
     */
    private $profiles;
    /**
     ...
     *           Semantically when InstrumentationScope isn't set, it is equivalent with
     *           an empty instrumentation scope name (unknown).
     *     @type \Opentelemetry\Proto\Profiles\V1experimental\ProfileContainer[]|\Google\Protobuf\Internal\RepeatedField $profiles
     *           A list of ProfileContainers that originate from an instrumentation scope.
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.profiles.v1experimental.ProfileContainer profiles = 2;</code>
     * @param \Opentelemetry\Proto\Profiles\V1experimental\ProfileContainer[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProfiles($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Opentelemetry\Proto\Profiles\V1experimental\ProfileContainer::class);
        $this->profiles = $arr;
