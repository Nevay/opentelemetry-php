 ...
 *
 * Generated from protobuf message <code>opentelemetry.proto.profiles.v1experimental.ResourceProfiles</code>
 */
class ResourceProfiles extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.profiles.v1experimental.ScopeProfiles scope_profiles = 2;</code>
     */
     ...
     *           The resource for the profiles in this message.
     *           If this field is not set then no resource info is known.
     *     @type \Opentelemetry\Proto\Profiles\V1experimental\ScopeProfiles[]|\Google\Protobuf\Internal\RepeatedField $scope_profiles
     *           A list of ScopeProfiles that originate from a resource.
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.profiles.v1experimental.ScopeProfiles scope_profiles = 2;</code>
     * @param \Opentelemetry\Proto\Profiles\V1experimental\ScopeProfiles[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setScopeProfiles($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Opentelemetry\Proto\Profiles\V1experimental\ScopeProfiles::class);
